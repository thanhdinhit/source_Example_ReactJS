...
const Select = React.createClass({
	...
	propTypes: {
		...
		titleValue: React.PropTypes.string,			// title before value
		titlePlaceHolder: React.PropTypes.string	// title placeholder
	},
				...
				<div className="Select-placeholder">
					{
						this.props.titlePlaceHolder ?
							<div className="Select-title-placeholder"> {this.props.titlePlaceHolder}
							</div> : null
					}
	...
	renderInput(valueArray, focusedOptionIndex) {
		if (this.props.inputRenderer) {
			...
			// TODO: Check how this project includes _.assign()
			const inputProps = _.assign({}, this.props.inputProps, {
				role: 'combobox',
			...
			<div ref={ref => this.wrapper = ref}
				...
				>
					<span className="Select-multi-value-wrapper" id={this._instancePrefix + '-value'}>
						{
							this.props.titleValue && valueArray.length ?
								<div className="Select-title-value"> {this.props.titleValue}</div>
								: null
