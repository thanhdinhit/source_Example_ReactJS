...
export const NewEmployeeContainer = React.createClass({

  render: function () {
    return (
      <NewEmployee
        {...this.props}
        submitEmployee={this.props.addEmployee}
        title='NEW_EMPLOYEE'
      />
    );
  }
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    addEmployee: bindActionCreators(employeeActions.addEmployee, dispatch),
