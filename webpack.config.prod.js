...
const GLOBALS = {
  ...
  // 'SOCKET_DATA': JSON.stringify('http://103.199.7.167:9092/socket-notification'),
  // 'API_DATA': JSON.stringify('http://103.199.7.167:8080/v1/'),
  // 'API_FILE': JSON.stringify('http://103.199.7.167:8080/v1/files'),
